...
label_dom1=[]
class_names1=[]
path_dom1='/raid/biplab/divyam/Divyam/office_home_dg/'+domains[0]+'/train'
...
label_dom2=[]
class_names2=[]
path_dom2='/raid/biplab/divyam/Divyam/office_home_dg/'+domains[1]+'/train'
...
label_dom3=[]
class_names3=[]
path_dom3='/raid/biplab/divyam/Divyam/office_home_dg/'+domains[2]+'/train'
...
test_label_dom=[]
test_domain_names=[]
test_path_dom='/raid/biplab/divyam/Divyam/office_home_dg/'+domains[3]+'/val'
...
best_open_set_acc = 0
best_avg_acc = 0
accuracy_file_path = "/raid/biplab/divyam/Divyam/office_home_dg/output/realworld.txt"  
...
for epoch in range(num_epochs):
    ...
    TRAIN_MODEL_PATH = Path("/raid/biplab/divyam/Divyam/office_home_dg/output/realworld")
    ...
    MODEL_PATH = "/raid/biplab/divyam/Divyam/office_home_dg/output/realworld"
    ...
    with torch.no_grad():
        ...
        if average_acc > best_avg_acc:
            ...
            TEST_MODEL_PATH = Path("/raid/biplab/divyam/Divyam/office_home_dg/output")
